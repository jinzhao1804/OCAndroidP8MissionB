...
class DeleteCandidatUseCase @Inject constructor(private val candidatRepository: CandidatRepository) {
    ...
    suspend fun execute(candidat: Candidat){
        return try {
            ...
            candidatRepository.deleteCandidat(candidat)  // Save the Candidat
        } catch (e: Exception) {
